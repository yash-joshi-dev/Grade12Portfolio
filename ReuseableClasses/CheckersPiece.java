...
public class CheckersPiece {
	 ...
	 * @throws ArrayOutOfBoundsException if invalid row or col index is entered.
	 */
	...
	/**
	 * Returns the coordinates of all spots the selected piece can jump to (and delete other pieces in the process).
	 * @return an arraylist containing coordinates of all possible jumping spots.
	 */
	public ArrayList<int[]> jumpMoves() {
